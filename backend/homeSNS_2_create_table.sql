...
CREATE TABLE `USER` (
	...
	`USER_BOD`	DATE	NULL,
	`USER_PROFILE_IMAGE_URL`	VARCHAR(300)	NULL DEFAULT "img/noimage.png",
...
CREATE TABLE `GROUP_LIST` (
	...
	`GROUP_PROFILE_IMAGE_URL`	VARCHAR(300)	NULL DEFAULT "img/noimage.png",
...
CREATE TABLE `COMMENT_TAG` (
    ...
    constraint `comment_tag_PK` primary key(COMMENT_ID, COMMENT_TAG)
);
...
ALTER TABLE `COMMENT_TAG` ADD CONSTRAINT `FK_COMMENT_TO_COMMENT_TAG_1` FOREIGN KEY (
	`COMMENT_ID`
)
REFERENCES `COMMENT` (
	`COMMENT_ID`
