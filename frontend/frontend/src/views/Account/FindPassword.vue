  ...
  <v-app class="my-background">
    <div class="container">
      ...
      >
        ...
        <v-card-title class="main-text justify-center text-h4 font-weight-bold">비밀번호 찾기</v-card-title>
        <br />
        <v-card-title class="main-text justify-left text-h4 font-weight-bold">가입시 <br />사용합 이메일로<br />비밀번호가<br />발송됩니다.</v-card-title>
      </v-card>
    </div>
    <br />
